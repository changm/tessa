...
const int kBufferPadding = 16;
    ...
    public:
		...
		static const bool useTessa_default;
		static const bool tessaInline_default;
		static const bool tessaTypePropagation_default;
		static const bool tessaVerbose_default;
		static const bool tessaInterp_default;
    ...
    public:
		...
		void setIsUserScript(bool value);
		bool isUserScript();
    ...
    private:
		 ...
		 * Need public for other code generators
         */
	public:
	...
	private:
		...
		/***
		 * Flag if we are running a user script and not startup scripts
		 */
		bool				runningUserScript;
