...
namespace avmplus
{
	...
	const bool AvmCore::useTessa_default = false;
	const bool AvmCore::tessaVerbose_default = false;
	const bool AvmCore::tessaInterp_default = false;
	const bool AvmCore::tessaInline_default = false;
	const bool AvmCore::tessaTypePropagation_default = false;
    ...
    AvmCore::~AvmCore()
    {
		...
		if (config.useTessa) {
			TessaCodeGenerators::TessaCodeGenerator::deleteInstance(); 
			TessaTypes::TypeFactory::deleteInstance();
		}
    }
