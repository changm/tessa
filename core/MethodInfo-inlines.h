...
REALLY_INLINE int32_t MethodInfoProcHolder::testThisCall(MethodEnv* env, int32_t argc) {
	(void)env;
	(void)argc;
	return 10;
}
...
REALLY_INLINE int32_t MethodInfo::isOverride() const {
	return _flags & OVERRIDE;
}
