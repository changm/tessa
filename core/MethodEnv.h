...
namespace avmplus
{
    ...
    public:	// Has to be public so non-avmplus code generators can access these fields
    ...
    private:
        ...
        static Atom coerceEnter_Tessa_interp(MethodEnv* env, int32_t argc, Atom* argv);
		static Atom coerceEnter_Tessa_native(MethodEnv* env, int32_t argc, Atom* argv);
