...
//   flog/engine.js
    ...
    public class Sphere implements Shape {
        ...
        public function intersect (ray:Ray):IntersectionInfo {
            ...
            var dst = RVector.subtract(ray.position, this._position);
    ...
    public class Plane implements Shape {
        ...
        public function intersect (ray:Ray):IntersectionInfo{
            ...
            var Vd = this._position.dot(ray.direction);
            if(Vd == 0) return info; // no intersection

            var t = -(this._position.dot(ray.position) + this.d) / Vd;
            if(t <= 0) return info;
            ...
            if(this._material.hasTexture){
                var vU = new RVector(this._position.y, this._position.z, -this._position.x);
                var vV = vU.cross(this._position);
