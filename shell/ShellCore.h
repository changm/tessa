...
namespace avmshell
{
    ...
    public:
		...
		bool useTessa;					// copy to config
		bool tessaVerbose;				// copy to config
		bool tessaInterp;				// copy to config
		bool tessaTypePropagation;		// copy to config
		bool tessaInline;				// copy to config
